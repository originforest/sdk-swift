...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "brainpoint" => "bpoint.lee@live.com" }
  # Or just: spec.author    = "brainpoint"
  # spec.authors            = { "brainpoint" => "bpoint.lee@live.com" }
  # spec.social_media_url   = "https://twitter.com/brainpoint"
